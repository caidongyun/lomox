...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_LxOperate_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_LxOperate_t qt_meta_stringdata_LxOperate = {
    {
QT_MOC_LITERAL(0, 0, 9), // "LxOperate"
QT_MOC_LITERAL(1, 10, 16), // "setupJsAPIObject"
QT_MOC_LITERAL(2, 27, 0) // ""

    },
    "LxOperate\0setupJsAPIObject\0"
};
...
const QMetaObject LxOperate::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_LxOperate.data,
      qt_meta_data_LxOperate,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *LxOperate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LxOperate.stringdata0))
